 ...
 */
  ...
  #if AXIS_IS_TMC(X) //Exacto Motor Drivers settings
   ...
   */
  #define  X_SLAVE_ADDRESS 0 //Exacto Motor Drivers
  #define  Y_SLAVE_ADDRESS 0 //Exacto Motor Drivers
  #define  Z_SLAVE_ADDRESS 0 //Exacto Motor Drivers
  ...
  #define E0_SLAVE_ADDRESS 0 //Exacto Motor Drivers
   ...
   */
  #define TMC_DEBUG //Exacto Motor Drivers
